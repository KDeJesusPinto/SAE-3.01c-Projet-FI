...
-- Étudiants 1-8 : BUT2 2025 puis BUT3 2025
...
-- Étudiants 17-24 : BUT2 2025 (autres étudiants)
...
INSERT INTO STAGE (id_stage, typeS, date_debut, date_fin, duree_stage, unite_duree, titre_stage, theme_stage, id_maitre, id_demarche) VALUES
(4, 'Stage de fin d\'études', '2025-10-15', '2025-04-15', 6, 'mois', 'Développement d\'applications mobiles iOS/Android', 'Mobile Development', 6, NULL);
...
-- Stages des étudiants BUT2 2025 (étudiants 18-24, sauf 17)
INSERT INTO STAGE (id_stage, typeS, date_debut, date_fin, duree_stage, unite_duree, titre_stage, theme_stage, id_maitre, id_demarche) VALUES
(12, 'Stage professionnel', '2025-04-01', '2025-06-30', 3, 'mois', 'Création d\'interfaces utilisateur modernes', 'UX/UI Design', 1, NULL),
(13, 'Stage professionnel', '2025-04-15', '2025-07-15', 3, 'mois', 'Analyse de données clients pour le marketing', 'Data Analytics', 2, NULL),
(14, 'Stage professionnel', '2025-04-01', '2025-06-30', 3, 'mois', 'Développement d\'API REST pour microservices', 'Architecture logicielle', 3, NULL),
(15, 'Stage professionnel', '2025-04-15', '2025-07-15', 3, 'mois', 'Mise en place d\'une solution IoT', 'Internet des Objets', 4, NULL),
(16, 'Stage professionnel', '2025-04-01', '2025-06-30', 3, 'mois', 'Développement d\'un chatbot intelligent', 'Intelligence Artificielle', 5, NULL),
(17, 'Stage professionnel', '2025-04-15', '2025-07-15', 3, 'mois', 'Automatisation des tests logiciels', 'QA & Testing', 6, NULL),
(18, 'Stage professionnel', '2025-04-01', '2025-06-30', 3, 'mois', 'Développement d\'un système de monitoring', 'DevOps', 7, NULL),
(19, 'Stage professionnel', '2025-04-15', '2025-07-15', 3, 'mois', 'Création d\'un CMS personnalisé', 'Développement Web', 8, NULL);
...
INSERT INTO DEMARCHE (id_demarche, source, typeD, situation, date_envoi, date_relance, resultat, raison_refus, cv, lettre_motiv, id_entreprise, id_etudiant) VALUES
(15, 'Réseau école', 'Partenariat', 'Acceptée', '2025-09-01', NULL, 'Stage obtenu', NULL, 'cv_leroy.pdf', 'lm_leroy.pdf', 6, 6),
...
(20, 'Réseau école', 'Partenariat', 'Acceptée', '2025-02-01', NULL, 'Stage obtenu', NULL, 'cv_lemoine.pdf', 'lm_lemoine.pdf', 1, 18),
(21, 'Réseau école', 'Partenariat', 'Acceptée', '2025-02-15', NULL, 'Stage obtenu', NULL, 'cv_andre.pdf', 'lm_andre.pdf', 2, 19),
(22, 'Réseau école', 'Partenariat', 'Acceptée', '2025-02-01', NULL, 'Stage obtenu', NULL, 'cv_roux.pdf', 'lm_roux.pdf', 3, 20),
(23, 'Réseau école', 'Partenariat', 'Acceptée', '2025-02-15', NULL, 'Stage obtenu', NULL, 'cv_david.pdf', 'lm_david.pdf', 4, 21),
(24, 'Réseau école', 'Partenariat', 'Acceptée', '2025-02-01', NULL, 'Stage obtenu', NULL, 'cv_bertrand.pdf', 'lm_bertrand.pdf', 5, 22),
(25, 'Réseau école', 'Partenariat', 'Acceptée', '2025-02-15', NULL, 'Stage obtenu', NULL, 'cv_morel.pdf', 'lm_morel.pdf', 6, 23),
(26, 'Réseau école', 'Partenariat', 'Acceptée', '2025-02-01', NULL, 'Stage obtenu', NULL, 'cv_fontaine.pdf', 'lm_fontaine.pdf', 7, 24);
...
-- Soutenances pour BUT2 2025 (certains étudiants : 18, 19, 20, 21, 22, 23, 24, 16)
INSERT INTO SOUTENANCE (id_soutenance, salle, nom_bat, dateS, h_debut, h_fin, id_stage) VALUES
...
-- - 3 promotions (BUT2 2025, BUT2 2025, BUT3 2025)
-- - Les étudiants 1-8 de BUT3 2025 étaient en BUT2 2025

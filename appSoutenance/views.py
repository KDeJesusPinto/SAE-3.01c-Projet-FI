...
def accueil_etudiant():
    ...
    return render_template("etudiant/accueil_etu.html",
                           accueil="accueil_etudiant",
                           prenom="Leni",
                           nom="Doe",
                           title="Accueil",
                           liste_dem=lst_demarches)
...
def demarches():
    ...
    return render_template("etudiant/demarches.html",
                           accueil="accueil_etudiant",
                           title="Mes démarches",
                           liste_dem=lst_demarches)
...
def info_stage():
    return render_template("etudiant/info_stage_valide.html",
                           accueil="accueil_etudiant",
                           title="Mon stage")
...
def nouvelle_demarche1():
    return render_template("etudiant/nouvelle_demarche1.html",
                           accueil="accueil_etudiant",
...
def nouvelle_demarche2():
    return render_template("etudiant/nouvelle_demarche2.html",
                           accueil="accueil_etudiant",
                           title="Nouvelle démarche")
...
def nouvelle_demarche3():
    return render_template("etudiant/nouvelle_demarche3.html",
                           accueil="accueil_etudiant",
                           title="Nouvelle démarche")
...
def resume_demarche_etudiant():
    return render_template("etudiant/resume_demarche.html",
                           accueil="accueil_etudiant",
                           title="Résumé de la démarche")
...
def accueil_enseignant():
    return render_template("enseignant/accueil_enseignant.html",
...
def planning_enseignant():
    return render_template("enseignant/planning_enseignant.html",
                           accueil="accueil_enseignant",
...
def liste_etu_enseignant():
    ...
    return render_template("enseignant/lst_etudiants_enseignant.html",
                           accueil="accueil_enseignant",
...
def detail_etudiant_ens():
    return render_template("admin/detail_etudiant_ens.html",
                           accueil="accueil_enseignant",
